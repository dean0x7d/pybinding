...
class Range(ProgressBar):
    def __init__(self, maxval, file_name="", output=sys.stdout, custom_widgets=None, term_width=80):
        ...
        super().__init__(widgets=custom_widgets if custom_widgets else default_widgets,
                         maxval=maxval, term_width=term_width, fd=output, redirect_stdout=True)
