...
htmlhelp_basename = 'pybindingdoc'
...
latex_documents = [
    (master_doc, 'pybinding.tex', 'pybinding Documentation',
     'Dean Moldovan', 'manual'),
]
...
man_pages = [
    (master_doc, 'pybinding', 'pybinding Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pybinding', 'pybinding Documentation',
     author, 'pybinding', 'One line description of project.',
     'Miscellaneous'),
]
